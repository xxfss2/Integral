<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="BackLogin" %>
    ...
    <div style ="width :400px;height:337px; background-color:White; margin-top:5px;border :solid 1px #BBBBBB; text-align :left">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="BTsubmit" runat="server" Text="登录" Height="28px" Width="66px" OnClick="BTsubmit_Click" />
                    </td>
                <td>
                </td>
            </tr>
